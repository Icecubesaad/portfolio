...
const Homepage = () => {
  ...
  const [arrow, setarrow] = useState("50px");
  ...
  const [styleImage3, setstyleImage3] = useState({
    height: "auto",
    width: "80%",
  });
  useEffect(() => {
  ...
  const handlers = useSwipeable({
    ...
    onSwipedRight: () => {
      index == 0 ? setinde(2) : setindex((prevIndex) => prevIndex - 1);
    },
  });
  const handlers2 = useSwipeable({
    onSwipedLeft: () => {
      indexB == 2 ? setindexB(0) : setindexB((prevIndex) => prevIndex + 1);
    },
    onSwipedRight: () => {
      indexB == 0 ? setindexB(2) : setindexB((prevIndex) => prevIndex - 1);
    },
  });
          ...
          <div className="Navbar">
            <div className="socials">
              <a
                ...
                target="__blank"
                href="https://github.com/Icecubesaad"
              >
                <div className="gihub">
                  <svg
        ...
        <div className="about" style={{ fontFamily: "Inter" }} id="about">
          ...
          <div className="main">
            <div className="info" data-aos="fade-in">
              <h1>Hi there</h1>
              <p>
                I'm <span style={{ color: "orange" }}>Saad</span>, an
                18-year-old MERN stack developer. Since May 2022, I've been
                passionately learning and building my skills in web development.
                With a focus on the MERN stack{" "}
                <span style={{ color: "orange" }}>
                  (MongoDB, Express.js, React, and Node.js)
                </span>
                , I specialize in creating dynamic and user-friendly web
                applications. I have a solid foundation in React.js for
                front-end development and expertise in building{" "}
                <span style={{ color: "orange" }}>RESTful APIs</span> using
                Node.js and Express.js on the back-end. I'm committed to clean
                code, maintainable architecture, and staying up to date with the
                latest industry trends. I'm eager to contribute my skills to
                meaningful projects and collaborate with fellow developers to
                create impactful applications. Let's connect and explore the
                world of MERN stack development together!
              </p>
            </div>
            <div className="picture" data-aos="fade-in">
              <img src={image4} height="300px" width="200px" alt="" />
            </div>
          </div>
        </div>
          ...
          <div className="main-grid-project">
            <div className="project1">
              ...
              <p>
                ...
                different categories. A user can buy a book by logging in to
                thier account and read it in pdf format. This apps works on self
                made api.
              </p>
              <div className="button-project1">
                <a target="__blank" href="https://ice-online-book-store.vercel.app/">
                  <button className="btn1">Live site</button>
                </a>
                <a
                  target="__blank"
                  href="https://github.com/Icecubesaad/Online-book-store"
                >
            ...
            <div className="project2">
              ...
              >
                ...
                >
                  <img
                    src={RecipeImages[index].img}
                    height={styleImage2.height}
                    width={styleImage2.width}
                    alt=""
                    data-aos="flip-left"
                  />
                </div>
                <button
                  onClick={RecipeForward}
                  className="button-home"
                  style={{
                    backgroundColor: "transparent",
                    border: "none",
              ...
              <p>
                Introducing my MERN stack-powered recipe app: a comprehensive
                platform that fetches recipes from an open-source API and
                organizes them into different categories. Users can seamlessly
                navigate from categories to meals and access detailed recipes.
                The app features a recipe saving system, profile authentication,
                and a convenient search bar, allowing users to quickly find
                their desired recipes and create personalized collections.
              </p>
              <div className="button-project2">
                <a target="__blank" href="https://recipe-app-steel-zeta.vercel.app/">
                  <button className="btn1">Live site</button>
                </a>
                <a
                  target="__blank"
                  href="https://github.com/Icecubesaad/Recipe-App"
                >
                  <button className="btn1">Source code</button>
                </a>
              </div>
            ...
            <div className="project3" style={{ fontFamily: "Inter" }}>
              ...
              >
                ...
                >
                  <img
                    src={BlogApp[indexB].img}
                    height={styleImage3.height}
                    width={styleImage3.width}
                    alt=""
                    data-aos="flip-left"
                  />
                </div>
              ...
              <h1>Blog App</h1>
              <p>
                Introducing my MERN stack-powered blog application: a seamless
                platform for readers and writers. With user authentication, a
                liking system, trending and relatable blog algorithms, and
                categorized tags, this app offers an immersive experience. Users
                can create personalized author profiles, discover captivating
                content, engage in meaningful discussions, and express their
                appreciation through the liking system.
              </p>
              <div className="button-project3">
                <a target="__blank" href="https://blog-app-omega-olive.vercel.app/">
                  <button className="btn1">Live site</button>
                </a>
                <a target="__blank" href="https://github.com/Icecubesaad/Blog">
                  <button className="btn1">Source code</button>
                </a>
              </div>
            </div>
          ...
          <div className="box-contact">
            <form action="">
              ...
              <div className="btn-contact">
                <button className="btn1" onClick={send}>
                  Send
                </button>
              </div>
            </form>
